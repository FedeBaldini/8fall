...
export interface IconProps extends WithOptionalClassName {}
...
function Facebook(props: IconProps) {
  return (
    <Svg data-testid="Facebook" viewBox="0 0 448 512" {...props}>
...
function Instagram(props: IconProps) {
  return (
    <Svg data-testid="Instagram" viewBox="0 0 448 512" {...props}>
...
function Menu(props: IconProps) {
  return (
    <Svg data-testid="Menu" viewBox="0 0 448 512" {...props}>
...
function Close(props: IconProps) {
  return (
    <Svg data-testid="Close" viewBox="0 0 320 512" {...props}>
